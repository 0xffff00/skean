...
public class DateLearn {
	...
	public static void main(String[] args) {
		...
		System.out.println(DateFormatUtils.ISO_TIME_FORMAT.format(System.currentTimeMillis()));
		System.out.println(DateFormatUtils.ISO_TIME_NO_T_FORMAT.format(System.currentTimeMillis()));
		System.out.println(DateFormatUtils.ISO_TIME_NO_T_TIME_ZONE_FORMAT.format(System.currentTimeMillis()));
		System.out.println("--------");

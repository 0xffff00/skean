 ...
 * @since 2017-10-14
 */
public abstract class MultiPKMatrixVarCrudRestController<E, PK> {
...
//    @PutMapping("/{pk}")
//    public ResponseEntity<Object> httpCreateOrUpdate(@MatrixVariable(pathVar = "pk") Map<String,Object> pkMap,
//                                                     @RequestBody E entity) {
//        getCrudFunctions().getOneReader().apply()
